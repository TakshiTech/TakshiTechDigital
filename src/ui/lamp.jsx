  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-black to-gray-800 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl">
        Our <br /> Services
      </motion.h1>
    </LampContainer>
  );
    ...
    <div
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-black [--conic-position:from_70deg_at_center_top]">
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 text-black">
        {children}
      </div>
    </div>
  );
