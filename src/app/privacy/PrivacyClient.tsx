      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
            <p className="text-gray-600 mb-4"><strong>Last updated:</strong> June 03, 2025</p>
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4">
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us", or "Our" in this Agreement) refers to Takshi Tech Digital, H-187, Workwings, Sector-63, Noida.</li>
              ...
              <li><strong>Website</strong> refers to Takshi Tech Digital, accessible from <a href="http://www.takshitechdigital.com" className="text-blue-600 hover:underline">www.takshitechdigital.com</a></li>
            ...
            <p className="text-gray-600 mb-4">
              Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/cookies/" className="text-blue-600 hover:underline">Free Privacy Policy website article</a>.
            </p>
            <p className="text-gray-600 mb-4">We use both Session and Persistent Cookies for the purposes set out below:</p>
            <p className="text-gray-600 mb-2"><strong>Necessary / Essential Cookies</strong></p>
            <ul className="list-disc list-inside text-gray-600 mb-4">
              <li>Type: Session Cookies</li>
              <li>Administered by: Us</li>
              <li>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</li>
            </ul>
            <p className="text-gray-600 mb-2"><strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
            <ul className="list-disc list-inside text-gray-600 mb-4">
            ...
            <p className="text-gray-600 mb-2"><strong>Functionality Cookies</strong></p>
            <ul className="list-disc list-inside text-gray-600 mb-4">
              <li>Type: Persistent Cookies</li>
              <li>Administered by: Us</li>
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4">
              <li>By visiting this page on our website: <a href="http://www.takshitechdigital.com/contact" className="text-blue-600 hover:underline">www.takshitechdigital.com/contact</a></li>
              <li>By phone number: +91 8860692013</li>
            </ul>
          </div>
        </div>
      </section>
