        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4">
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us", or "Our" in this Agreement) refers to Web Digital Bazaar, H-187, Workwings, Sector-63, Noida.</li>
              ...
              <li><strong>Website</strong> refers to Web Digital Bazaar, accessible from <a href="http://www.takshitechdigital.com" className="text-blue-600 hover:underline">www.takshitechdigital.com</a></li>
